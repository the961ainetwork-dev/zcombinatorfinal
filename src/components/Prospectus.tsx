...
export default function Prospectus() {
  ...
  return (
    <div className="space-y-8 text-black" id="prospectus_page_container">
      {/* Hero Banner */}
      <div className="bg-[#FFF9E6] border-4 border-black p-6 sm:p-10 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] relative overflow-hidden">
        <div className="absolute top-2 right-2 bg-black text-[#FF6600] font-mono text-[10px] font-bold px-2 py-0.5 uppercase tracking-wider">
          Institutional Document
        </div>
        <div className="flex items-center gap-3 mb-4">
          <span className="p-2 bg-[#FF6600] text-white border-2 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] font-mono font-black">
            PROSPECTUS
          </span>
          <span className="font-mono text-xs font-bold text-gray-700 tracking-wider">NCEI LEBANON</span>
        </div>
        <h2 className="font-display font-black text-2xl sm:text-4xl uppercase tracking-tight leading-tight max-w-3xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-8 space-y-8">
          ...
          <div className="bg-white border-2 border-black p-6 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)]">
            <h3 className="font-display font-black text-lg uppercase tracking-tight border-b-2 border-black pb-2 mb-4 flex items-center gap-2">
              <BookOpen className="w-5 h-5 text-[#FF6600] shrink-0" />
              <span>Executive Summary</span>
            </h3>
            <p className="text-xs leading-relaxed font-sans text-gray-950 font-medium select-text">
            ...
            <p className="text-xs leading-relaxed font-sans text-gray-950 font-medium mt-3 select-text">
          ...
          <div className="bg-white border-2 border-black p-6 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] space-y-6">
            <h3 className="font-display font-black text-lg uppercase tracking-tight border-b-2 border-black pb-2 mb-4 flex items-center gap-2">
              <Layers className="w-5 h-5 text-[#FF6600] shrink-0" />
            ...
            <div className="space-y-4">
              <div className="border-2 border-black p-4 bg-[#F6F6EF] shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
                ...
                <p className="text-xs leading-relaxed font-sans font-medium text-gray-900 select-text">
                ...
                <p className="text-xs leading-relaxed font-sans font-medium text-gray-900 mt-2 select-text">
              ...
              <div className="border-2 border-black p-4 bg-white shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
                ...
                <p className="text-xs leading-relaxed font-sans font-medium text-gray-800">
                ...
                <ul className="text-xs font-sans font-medium text-gray-900 mt-2 space-y-1.5 list-disc pl-4">
              ...
              <div className="border-2 border-black p-4 bg-white shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
                ...
                <ul className="text-xs font-sans font-medium text-gray-900 mt-2 space-y-1.5 pl-4 list-disc">
          ...
          <div className="bg-white border-2 border-black p-6 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)]">
            <h3 className="font-display font-black text-lg uppercase tracking-tight border-b-2 border-black pb-2 mb-4 flex items-center gap-2">
              <Network className="w-5 h-5 text-[#FF6600] shrink-0" />
              <span>Social Enterprise & Public Sector Cluster Projects</span>
            </h3>
            <p className="text-xs font-sans font-semibold text-gray-800 mb-4">
              ...
              {coreClusters.map((cluster) => (
                <div key={cluster.number} className="border-2 border-black p-3.5 bg-white shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] flex items-start gap-2.5">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-gray-700 font-sans font-medium leading-normal">{cluster.desc}</p>
                  </div>
                </div>
              ))}
            </div>
        ...
        <div className="lg:col-span-4 space-y-8">
          ...
          {/* NCEI Support Panel */}
          <div className="bg-[#FFF9E6] border-2 border-black p-5 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
            <h4 className="font-display font-black text-base uppercase tracking-tight mb-3 flex items-center gap-1.5">
            ...
            <div className="space-y-3 font-mono text-[11px] font-bold text-black uppercase">
              <div className="border border-black p-2 bg-white">
                <p className="text-[#FF6600] font-black mb-1">Capacity Building</p>
              ...
              <div className="border border-black p-2 bg-white">
                <p className="text-[#FF6600] font-black mb-1">The "Sandbox" Toolkit</p>
              ...
              <div className="border border-black p-2 bg-white">
                <p className="text-[#FF6600] font-black mb-1">Candidate Backing</p>
            ...
            <div className="space-y-3">
              {prioritySectors.map((sector) => (
                <div key={sector.name} className="flex gap-2.5 items-start">
                  <span className="text-xl shrink-0 p-1 bg-[#F6F6EF] border border-black font-mono">
                    {sector.emoji}
                  </span>
                  <div>
                    <h5 className="font-mono text-xs font-black uppercase text-black leading-tight">{sector.name}</h5>
                    <p className="text-[11px] text-gray-600 font-sans font-medium mt-0.5 leading-normal">{sector.desc}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="bg-white border-2 border-black p-5 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
            ...
            <div className="space-y-3">
              {investmentChannels.map((channel, idx) => (
                <div key={idx} className="border border-gray-200 pl-3 py-1.5 border-l-4 border-l-[#FF6600]">
                  <h5 className="font-mono text-xs font-bold uppercase text-black leading-tight">{channel.title}</h5>
          ...
          <div className="bg-white border-2 border-black p-5 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
            ...
            <p className="text-xs leading-relaxed text-gray-800 font-sans font-medium mb-3">
          ...
          <div className="bg-[#FFF9E6] border-2 border-black p-5 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
            <h4 className="font-display font-black text-base uppercase tracking-tight mb-2 flex items-center gap-1.5">
              <Eye className="w-4 h-4 text-[#FF6600]" />
              <span>Commitment to Transparency</span>
            </h4>
            <p className="text-xs leading-relaxed text-black font-sans font-semibold [text-transform:none]">
