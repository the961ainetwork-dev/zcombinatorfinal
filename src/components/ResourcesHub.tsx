...
export default function ResourcesHub() {
  ...
  return (
    <div className="space-y-8 text-black" id="resources_hub_page">
      {/* Upper Title Band */}
      <div className="bg-[#FFF9E6] border-4 border-black p-6 sm:p-10 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] relative overflow-hidden">
        <div className="absolute top-2 right-2 bg-black text-[#FF6600] font-mono text-[9px] font-black px-2 py-0.5 uppercase">
          Ecosystem Papers
        </div>
        ...
        <p className="text-xs sm:text-sm font-mono mt-3 text-gray-700 uppercase tracking-wide font-bold">
      ...
      <div className="flex flex-wrap gap-2 border-b-4 border-black pb-4" id="resource_hub_toggles">
        <button
          ...
          className={`px-4 py-2 border-2 border-black font-black uppercase text-xs transition-all flex items-center gap-1.5 cursor-pointer ${
            activeResource === "hubspoke"
              ? "bg-[#FF6600] text-white shadow-[3px_3px_0px_0px_rgba(0,0,0,1)]"
              : "bg-white text-black hover:bg-[#F6F6EF] shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[0.5px] hover:translate-y-[0.5px] hover:shadow-none"
          }`}
        >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 animate-fade-in" id="hubspoke_paper_content">
          ...
          <div className="lg:col-span-8 space-y-8">
            ...
            <div className="bg-white border-2 border-black p-6 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)]">
              <span className="font-mono text-[#FF6600] font-black text-xs uppercase block mb-1">Resource Page 1: The Z961-Combinator</span>
              <h3 className="font-display font-black text-xl uppercase tracking-tight text-black mb-4 select-text">
                Navigating Complexity: Our Operational Hub-and-Spoke Model
              </h3>
              <p className="text-xs leading-relaxed text-gray-900 font-sans font-medium mb-4 select-text">
              ...
              <div className="space-y-4">
                <div className="border border-black p-4 bg-[#F6F6EF]">
            ...
            <div className="bg-white border-2 border-black p-6 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)]">
              <h3 className="font-display font-black text-base uppercase tracking-tight text-black border-b border-black pb-2 mb-4">
                Leadership Competencies: From Controllers to Evolutionary Architects
              </h3>
              <p className="text-xs leading-relaxed text-gray-800 font-sans font-medium mb-4 select-text">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div className="border border-black p-3.5 bg-[#FFF9E6]">
                  <h5 className="font-mono text-xs font-black uppercase text-black mb-1">Systems Thinking</h5>
                  <p className="text-[11px] text-gray-700 font-sans leading-relaxed">The ability to perceive the interconnectedness of regional macroeconomic shifts (e.g., energy price fluctuations) and local operational realities.</p>
                </div>
                <div className="border border-black p-3.5 bg-[#FFF9E6]">
                  <h5 className="font-mono text-xs font-black uppercase text-black mb-1">Strategic Foresight</h5>
                  <p className="text-[11px] text-gray-700 font-sans leading-relaxed">Transitioning from reactive firefighting to building organizational "pre-sensing" mechanisms that allow the "hub" to anticipate systemic tremors.</p>
                </div>
                <div className="border border-black p-3.5 bg-[#FFF9E6]">
                  <h5 className="font-mono text-xs font-black uppercase text-black mb-1">Distributed Empowerment</h5>
                  <p className="text-[11px] text-gray-700 font-sans leading-relaxed">Cultivating a high-trust environment where local "spokes" possess the autonomy to make rapid decisions on the ground, guided by centralized, AI strategic pillars.</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white border-2 border-black p-6 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] space-y-4">
              <h3 className="font-display font-black text-base uppercase tracking-tight text-black border-b border-black pb-2">
                Case Studies: Navigating Complexity
              </h3>
              
              <div className="border-l-4 border-[#FF6600] pl-4 space-y-1.5 py-1">
          ...
          <div className="lg:col-span-4 space-y-6">
            <div className="bg-white border-2 border-black p-5 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
              <h4 className="font-mono text-xs font-black uppercase tracking-wider text-[#FF6600] border-b border-black pb-2 mb-3">
                References & Citations
              </h4>
              <ul className="space-y-3 text-[11px] font-sans font-medium text-gray-750">
                <li className="border-b pb-2">
                  <span className="font-mono font-bold block text-black">McKinsey & Company</span>
                  <span className="text-gray-600">Middle East & Africa Insights (2026).</span>
                </li>
                <li className="border-b pb-2">
                  <span className="font-mono font-bold block text-black">Dodds, P. S., et al.</span>
                  <span className="text-gray-600">Information exchange and the robustness of organizational networks. (2003).</span>
                </li>
                <li className="border-b pb-2">
                  <span className="font-mono font-bold block text-black">Nnaomah, U. I., et al.</span>
                  <span className="text-gray-600">AI in risk management: An analytical comparison between the U.S. and Nigerian banking sectors. (2024).</span>
                </li>
                <li>
                  <span className="font-mono font-bold block text-black">Syamsir, S.</span>
                  <span className="text-gray-600">Leadership agility in a VUCA world. (2025).</span>
                </li>
              </ul>
            </div>
          </div>
      ...
      {activeResource === "leadership" && (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 animate-fade-in" id="leadership_paper_content">
          ...
          <div className="lg:col-span-8 space-y-8">
            ...
            <div className="bg-white border-2 border-black p-6 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)]">
              <span className="font-mono text-[#FF6600] font-black text-xs uppercase block mb-1">Resource Page 2: Leadership in the MENA Startup Ecosystem</span>
              <h3 className="font-display font-black text-xl uppercase tracking-tight text-black mb-4 select-text">
                The Evolutionary Architect: Leading Through Uncertainty
              </h3>
              <p className="text-xs leading-relaxed text-gray-900 font-sans font-semibold mb-4 select-text">
              ...
              <div className="space-y-6">
                ...
                <div className="border-2 border-black p-4 bg-white shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
                  ...
                  <ul className="text-xs font-sans font-medium text-gray-800 mt-2 pl-4 list-disc space-y-1">
            ...
            <div className="bg-[#FFF9E6] border-2 border-black p-6 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)]">
              <h3 className="font-display font-black text-base uppercase tracking-tight text-black mb-3">
                Core Leadership Competencies
              </h3>
              <p className="text-xs text-gray-900 font-sans font-semibold mb-4">
              ...
              <div className="space-y-3 font-mono text-xs font-bold text-black uppercase">
                <div className="bg-white border border-black p-3">
                  <p className="text-[#FF6600]">Adaptive Governance</p>
                  <p className="normal-case font-sans font-medium text-gray-700 text-[11px] mt-0.5">Leaders must cultivate the ability to interpret complex signals through diverse cultural and institutional systems.</p>
                </div>
                <div className="bg-white border border-black p-3">
                  <p className="text-[#FF6600]">Systems Thinking</p>
                  <p className="normal-case font-sans font-medium text-gray-700 text-[11px] mt-0.5">Success depends on the ability to perceive the interconnectedness of macroeconomic forces—such as energy price shifts—and translate them into actionable strategies.</p>
                </div>
                <div className="bg-white border border-black p-3">
                  <p className="text-[#FF6600]">Antifragile Tinkering</p>
                  <p className="normal-case font-sans font-medium text-gray-700 text-[11px] mt-0.5">We encourage "tinkering" as a formal methodology. By running small, iterative experiments, founders build structures that grow stronger when exposed to volatility.</p>
                </div>
                <div className="bg-white border border-black p-3">
                  <p className="text-[#FF6600]">Radical Transparency</p>
                  <p className="normal-case font-sans font-medium text-gray-700 text-[11px] mt-0.5">Our commitment to AI-Native Business Verification ensures that every entity maintains a real-time "health audit," effectively mitigating unquantifiable risk.</p>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-4 space-y-6">
            <div className="bg-white border-2 border-black p-5 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
              ...
              <ul className="space-y-3.5 text-[11px] font-sans font-medium text-gray-750">
                <li className="border-b pb-2">
                  <span className="font-mono font-bold block text-black">Danchin, A., Binder, P. M., & Noria, S.</span>
                  <p className="text-gray-600 mt-0.5 leading-normal">
