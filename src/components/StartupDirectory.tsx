      ...
      <div className="bg-white p-5 border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] space-y-4">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <button
            ...
            className="flex items-center gap-1.5 bg-[#FF6600] hover:bg-[#ff8533] text-white border-2 border-black px-4 py-2 text-xs font-black uppercase tracking-tight shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] active:translate-x-[1px] active:translate-y-[1px] active:shadow-none transition-all cursor-pointer"
          >
          ...
          filteredStartups.map((startup) => (
            ...
            >
              <div>
                ...
                <div className="flex items-start justify-between gap-3 mb-4">
                  <div className="flex items-center gap-3">
                    <span className="w-12 h-12 bg-[#FFF9E6] border-2 border-black flex items-center justify-center text-2xl shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] shrink-0 transition-transform">
                      {startup.logo || "🚀"}
                    </span>
                    <div>
                      <h3 className="font-display font-black text-black text-base uppercase tracking-tight group-hover:text-[#FF6600] transition">
                        {startup.name}
                      </h3>
                      <p className="text-[9px] text-gray-500 font-mono font-bold flex items-center gap-1 uppercase tracking-wider mt-0.5">
                        <Building className="w-3 h-3 text-[#FF6600]" />
                        <span>{startup.industry}</span>
                      </p>
                    </div>
                  </div>
                  <span className="text-[10px] font-mono font-black uppercase shrink-0 bg-[#FFF9E6] text-black border border-black px-2 py-0.5">
                    {startup.stage}
                  </span>
                </div>
              ...
              <div className="border-t-2 border-black pt-3 flex items-center justify-between text-[11px] text-black font-mono font-bold uppercase">
                ...
                <span className="text-[#FF6600] bg-[#FFF9E6] border border-black px-2 py-0.5">
                  💵 {startup.funding}
                </span>
              </div>
            </div>
      ...
      {selectedStartup && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-xs flex items-center justify-center p-4 z-50 animate-fade-in" id="startup_drawer_overlay">
          <div className="bg-white border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] max-w-2xl w-full overflow-hidden text-black rounded-none">
            {/* Header */}
            <div className="bg-[#FFF9E6] p-5 border-b-2 border-black flex items-start justify-between gap-3">
              <div className="flex gap-4 items-center">
                ...
                <div>
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    <span className="text-[10px] font-bold font-mono tracking-wider text-black bg-[#FF6600]/20 border border-black px-2.5 py-0.5 uppercase">
                      {selectedStartup.stage}
                    </span>
                  </div>
                  <p className="text-sm text-[#FF6600] font-bold uppercase tracking-tight">{selectedStartup.tagline}</p>
                </div>
              </div>
              <button
            ...
            <div className="p-6 space-y-6 overflow-y-auto max-h-[75vh]">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                <div className="bg-white p-3 border-2 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] flex items-center gap-2.5">
                  <Award className="w-4.5 h-4.5 text-[#FF6600] shrink-0" />
                  <div>
                ...
                <div className="bg-white p-3 border-2 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] flex items-center gap-2.5">
                  <Users className="w-4.5 h-4.5 text-[#FF6600] shrink-0" />
                  <div>
                ...
                <div className="bg-white p-3 border-2 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] flex items-center gap-2.5 col-span-2 sm:col-span-1">
                  <Calendar className="w-4.5 h-4.5 text-[#FF6600] shrink-0" />
                  <div>
                ...
                <div className="bg-white p-3 border-2 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] flex items-center gap-2.5">
                  <Globe className="w-4.5 h-4.5 text-[#FF6600] shrink-0" />
                  <div>
                    ...
                    <a
                      ...
                      className="text-xs font-black text-[#FF6600] hover:underline flex items-center gap-0.5 truncate"
                    >
                ...
                <div className="bg-white p-3 border-2 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] flex items-center gap-2.5">
                  <Landmark className="w-4.5 h-4.5 text-[#FF6600] shrink-0" />
                  <div>
                ...
                <div className="bg-white p-3 border-2 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] flex items-center gap-2.5">
                  <DollarSign className="w-4.5 h-4.5 text-[#FF6600] shrink-0" />
                  <div>
                    <span className="block text-[9px] text-gray-500 font-mono uppercase tracking-wider">Capitalization</span>
                    <span className="text-xs font-black text-[#FF6600]">{selectedStartup.funding.toUpperCase()}</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] overflow-hidden max-w-xl w-full rounded-none text-black">
            <div className="bg-[#FFF9E6] p-4 border-b-2 border-black flex items-center justify-between">
              <div className="flex items-center gap-2">
                <Landmark className="w-5 h-5 text-[#FF6600]" />
